          ...
          <div className={styles.modal_content_custom+" rounded "}>
              ...
              <div className="box-modal-body">
                ...
                <div className="w-50 mx-auto">
                  <button  className="btn bg-success w-100 fw-medium text-light" onClick={ubah}>Ubah Rujuk</button>
              </div>
              </div>
          </div>
      </div>)
